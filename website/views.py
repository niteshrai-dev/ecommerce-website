...
def add_to_cart(item_id):
    ...
    if item_exists:
        try:
            ...
            db.session.commit()
            flash(f'Quantity of {item_exists.product.product_name} has been update')
    ...
    try:
        ...
        flash(f'{new_cart_item.product.product_link} has not been added to cart')
    ...
    try:
        ...
        for item in customer_cart:
            ...
            if product.in_stock >= item.quantity:
                ...
                flash(f'{product.product_name} is out of stock')
